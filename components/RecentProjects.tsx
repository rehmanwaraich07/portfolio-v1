        ...
        {projects.map((item) => (
          ...
          >
            <Link href={item.link} target="_blank">
              <PinContainer
                title="/github.com/rehmanwaraich07/"
                href="https://github.com/rehmanwaraich07"
              >
                <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[27vh] lg:h-[30vh] mb-10">
                  ...
                  <Image
                    src={item.img}
                    alt="cover"
                    className="z-10 absolute bottom-0 left-0 right-0 w-full h-full rounded-t-2xl lg:object-contain max-md:object-fill"
                    width={800}
                    height={800}
                  />
                </div>
